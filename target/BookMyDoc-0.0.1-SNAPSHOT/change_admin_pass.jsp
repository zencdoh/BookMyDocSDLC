...
<form action="ControlServlet" method="post" name="change_admin_pass">
...
<input id="confirmnewpassword" name="confirmnewpassword" type="password" required/><br /><br />

<input type="hidden" name="page" value="change_admin_pass.jsp" />
...
<li><a href="change_admin_pass.jsp">Change Password</a></li>
